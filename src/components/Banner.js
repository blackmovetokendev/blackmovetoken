    ...
    return (
        <section id='home' className='w-full mt-5 p-4 text-center lg:flex lg:justify-center lg:gap-x-8'>
            <div className='w-2/4 m-auto'>
                ...
                <button onClick={e => navigate('/google.play.com') } className='rounded p-2 uppercase text-centermt-5'>
                    <img src={googlePLay} className='' alt=''/>
                </button>
                <button onClick={e => navigate('/appstore.com') } className='rounded p-2 uppercase text-centermt-5'>
